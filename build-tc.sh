...
llvm_commit_url="https://github.com/NFS-Project/llvm-project/commit/$short_llvm_commit"
...
git clone nfs86@git.pf.osdn.net:/gitroot/n/nf/nfs86/NFS-clang.git -b master rel_repo
pushd rel_repo || exit
rm -fr ./*
cp -r ../install/* .
git add .
